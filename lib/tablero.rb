...
module ModeloQytetet
  ...
  def inicializar
    ...
    titulocalle1 = TituloPropiedad.new("Calle Buena Vista",500,50,1.0,150,250)
    @casillas << Casilla.crea_calle(1,titulocalle1)
    #@casillas.at(1).titulo.casilla = @casillas.at(1)
    titulocalle2 = TituloPropiedad.new("Calle Doctor Victor Escribano",600,60,1.2,150,250)
    @casillas << Casilla.crea_calle(2,titulocalle2)
    #@casillas.at(2).titulo.casilla = @casillas.at(2)
    titulocalle3 = TituloPropiedad.new("Calle Arabial",700,70,1.4,150,250)
    @casillas << Casilla.crea_calle(3,titulocalle3)
    #@casillas.at(3).titulo.casilla = @casillas.at(3)
    titulocalle4 = TituloPropiedad.new("Calle Periodista Jose Maria Carulla",800,80,1.6,150,250)
    @casillas << Casilla.crea_casilla(4,0,TipoCasilla::SORPRESA)
    ...
    titulocalle5 = TituloPropiedad.new("Avenida de Madrid",900,90,1.8,150,250)
    @casillas << Casilla.crea_casilla(7,0,TipoCasilla::SORPRESA)
    @casillas << Casilla.crea_calle(8,titulocalle5)
    #@casillas.at(8).titulo.casilla = @casillas.at(8)
    titulocalle6 = TituloPropiedad.new("Camino de Ronda",1000,100,2.0,150,250)
    ...
    titulocalle7 = TituloPropiedad.new("Calle Pedro Antonio de Alarcon",830,80,1.6,150,250)
    @casillas << Casilla.crea_calle(11,titulocalle7)
    #@casillas.at(11).titulo.casilla = @casillas.at(11)
    titulocalle8 = TituloPropiedad.new("Calle Recogidas",780,80,1.6,150,250)
    @casillas << Casilla.crea_calle(12,titulocalle8)
    #@casillas.at(12).titulo.casilla = @casillas.at(12)
    titulocalle9 = TituloPropiedad.new("Avenida de Andalucia",620,60,1.2,150,250)
    @casillas << Casilla.crea_calle(13,titulocalle9)
    #@casillas.at(13).titulo.casilla = @casillas.at(13)
    @casillas << Casilla.crea_casilla(14,0,TipoCasilla::SORPRESA)
    @casillas << Casilla.crea_casilla(15,0,TipoCasilla::JUEZ)
    titulocalle10 = TituloPropiedad.new("Avenida Juan Pablo II",550,50,1.1,150,250)
    @casillas << Casilla.crea_calle(16,titulocalle10)
    #@casillas.at(16).titulo.casilla = @casillas.at(16)
    titulocalle11 = TituloPropiedad.new("Calle Curro Cuchares",950,95,1.9,150,250)
    ...
    titulocalle12 = TituloPropiedad.new("Calle Elvira",870,90,1.9,150,250)
  ...
  def obtener_casilla_final(casilla, desplazamiento)
    ...
    aux = @casillas.at((posicion + desplazamiento) % @casillas.length)
